    ...
    <div className="animate-fade-in">
      <div className="flex items-center justify-between mb-8 stagger-1 animate-fade-in">
        <div>
          ...
          <p className="text-base text-rf-gray-light dark:text-gray-500 mt-1">Reservaciones de lotes desde la web</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="card p-16 text-center animate-scale-in">
            <div className="w-16 h-16 mx-auto mb-5 rounded-full bg-rf-cream dark:bg-gray-800 flex items-center justify-center">
              ...
              >
                <div className="flex items-start justify-between flex-wrap gap-4">
                  <div className="flex items-start gap-4 min-w-0 flex-1">
                    <div className="w-10 h-10 rounded-xl bg-rf-cream dark:bg-gray-800 flex items-center justify-center flex-shrink-0">
                      <Bookmark size={18} className="text-rf-gold dark:text-rf-gold-light" />
                    </div>
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        <p className="font-semibold text-rf-dark dark:text-gray-100">Apartado #{sale.id}</p>
                      ...
                      {days !== null && (
                        <div className={`mt-2 inline-flex items-center gap-1.5 text-xs font-medium px-2 py-1 rounded-lg ${
                          days <= 0 ? 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300' :
                          days <= 3 ? 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-300' :
          ...
          <div className="card p-6 w-full max-w-sm shadow-premium-xl animate-scale-in" onClick={(e) => e.stopPropagation()}>
            <div className="text-center">
              <div className={`w-14 h-14 mx-auto mb-4 rounded-full flex items-center justify-center ${
                confirmAction.type === 'paid' ? 'bg-emerald-100 dark:bg-emerald-900/30' : 'bg-red-100 dark:bg-red-900/30'
              }`}>
